            ...
            <Container>
                <div className="profile d-md-flex mt-5 gap-5">
                    <div className="left w-100">
                        {dataLogin.aslogin === "partner" ? (<p className='fw-bold fs-3'>Profile Partner</p>) : (<p className='fw-bold fs-3'>My Profile</p>)}
                        <hr />
                    ...
                    {dataLogin.aslogin === "partner" ? (<div className="right w-100 mt-5 mt-md-0">
